...
describe('Ethereum Address Value Object', () => {
    ...
    describe('Creation', () => {
        it('should create a valid ethereum address', () => {
            const ethereumAddress = EthereumAddress.create({ value: ETHEREUM_ADDRESS });
        ...
        it('should throw an error with invalid address', () => {
            ...
            expect(() => EthereumAddress.create({ value: INVALID_ETHEREUM_ADDRESS })).toThrow(
    ...
    describe('Ethereum Address', () => {
        it('should Equal two instances with same value address', () => {
            const ethereumAddress1 = EthereumAddress.create({ value: ETHEREUM_ADDRESS });
            const ethereumAddress2 = EthereumAddress.create({ value: ETHEREUM_ADDRESS });
        ...
        it('should NOT Equal two instances with different value address', () => {
            const ethereumAddress1 = EthereumAddress.create({ value: ETHEREUM_ADDRESS });
            const ethereumAddress2 = EthereumAddress.create({ value: ETHEREUM_ADDRESS_2 });
